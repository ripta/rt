...
// NewRunCommand returns the `cg run` subcommand. It executes a child command,
// annotating each line of stdout and stderr with a stream indicator and an
...
func NewRunCommand() *cobra.Command {
	...
	// program; everything after passes through to the child untouched. The --
	// separator stays honored regardless.
